...
- source: CI variables used but not defined in the repo (GitLab settings, runner or includes): CVG_PIPELINES_PROJECT, EXTRA_DESTINATION_ARGS, EXTRA_DESTINATION_TAG, MYSQL_VERSION, SEMANTIC_DESTINATION_ARGS, SEMANTIC_TAG; git cannot see these  # .gitlab-ci.yml:3
