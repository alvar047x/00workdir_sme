...
- terraform variables: 64 roots declare 397 required (no default); 158 root x env var files checked, 47 leave required variables unset by anything in git; a TF_VAR_<name> in GitLab project CI settings would still supply them, and git cannot see those  # hcl2 over .tf and var files
